# 🐵 Monkey Mirror
 Bu proje Python programlama dilinde , OpenCV ve MediaPipe kütüphanelerini kullanılarak web kamerasından alınan görüntüleri gerçek zamanlı olarak işleyen ve kullanıcının yüz ifadeleri ile el hareketlerini algılayıp bunlara uygun olarak hazırlanmış maymun resimlerinin ekranda gösterilmesini sağlayan bir projedir.
